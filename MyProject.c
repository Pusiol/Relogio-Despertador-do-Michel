...
//                └───┘
//
// Este é um relógio digital com
// lcd 16x2, PIC 16F628A e um rtc
// genérico. O código também inclui
// uma saída para alarme.
//
// A hora é ajustada por cursor, o
// que torna o ajuste mais simples e
// rápido que em relógios comuns. As
// funcionalidades também incluem dia
// da semana e 7 alarmes programáveis.
//
...
void ajust(){
    ...
    if(flag1){
        ...
        Soft_I2C_Write(0xD0);
        Soft_I2C_Write(0);
        Soft_I2C_Write(seconds);              // Start from address 2
